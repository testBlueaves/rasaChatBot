...
//    enable this if u have configured the bot to start the conversation.
    ...
    user_id = document.getElementById('ids').value;
//    user_id = $(this).data("abc")
//    log.console(user_id);
...
//        data: JSON.stringify({ "name": action_name, "policy": "MappingPolicy", "confidence": "0.98" }),
        ...
        error: function(xhr, textStatus, errorThrown) {
            ...
            setBotResponse("");
            console.log("Error from bot end: ", textStatus,errorThrown);
            $("#userInput").prop('disabled', false);
        }
    });
}
...
function setUserResponse(message) {
    var UserResponse = '<img class="userAvatar" src=' + "./static/img/User.png" + '><p class="userMsg">' + message + ' </p><div class="clearfix"></div>';
...
function send(message) {
    ...
    $.ajax({
        ...
        success: function(botResponse, status) {
            ...
            setBotResponse([{"text":botResponse.response}]);
